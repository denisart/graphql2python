...
@pytest.mark.parametrize(
    ...
    [
        ('f', GraphQLField(type_=GraphQLScalarType('S')), "    f: _t.Optional['S'] = Field(default=None)"),
        ('f', GraphQLField(type_=GraphQLNonNull(GraphQLScalarType('S'))), "    f: 'S'"),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLScalarType('S'))),
            "    f: _t.Optional[_t.List[_t.Optional['S']]] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLScalarType('S')))),
            "    f: _t.List[_t.Optional['S']]",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLNonNull(GraphQLScalarType('S')))),
            "    f: _t.Optional[_t.List['S']] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLNonNull(GraphQLScalarType('S'))))),
            "    f: _t.List['S']",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLList(GraphQLScalarType('S')))),
...
@pytest.mark.parametrize(
    ...
    [
        (
            'f',
            GraphQLField(type_=GraphQLEnumType('S', {})),  # type: ignore
            "    f: _t.Optional['S'] = Field(default=None)",
        ),
        ('f', GraphQLField(type_=GraphQLNonNull(GraphQLEnumType('S', {}))), "    f: 'S'"),  # type: ignore
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLEnumType('S', {}))),  # type: ignore
            "    f: _t.Optional[_t.List[_t.Optional['S']]] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLEnumType('S', {})))),  # type: ignore
            "    f: _t.List[_t.Optional['S']]",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLNonNull(GraphQLEnumType('S', {})))),  # type: ignore
            "    f: _t.Optional[_t.List['S']] = Field(default_factory=list)",
        ),
        (
            'f',
        ...
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLList(GraphQLEnumType('S', {})))),  # type: ignore
            "    f: _t.Optional[_t.List[_t.Optional[_t.List[_t.Optional['S']]]]] = Field(default_factory=list)",
        ),
    ],
)
...
@pytest.mark.parametrize(
    'field_name, field, result',
    [
        ('f', GraphQLField(type_=GraphQLUnionType('S', [])), "    f: _t.Optional['S'] = Field(default=None)"),
        ('f', GraphQLField(type_=GraphQLNonNull(GraphQLUnionType('S', []))), "    f: 'S'"),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLUnionType('S', []))),
            "    f: _t.Optional[_t.List[_t.Optional['S']]] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLUnionType('S', [])))),
            "    f: _t.List[_t.Optional['S']]",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLNonNull(GraphQLUnionType('S', [])))),
            "    f: _t.Optional[_t.List['S']] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLNonNull(GraphQLUnionType('S', []))))),
            "    f: _t.List['S']",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLList(GraphQLUnionType('S', [])))),
            "    f: _t.Optional[_t.List[_t.Optional[_t.List[_t.Optional['S']]]]] = Field(default_factory=list)",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            'f',
            GraphQLField(
                type_=GraphQLNonNull(GraphQLList(GraphQLUnionType('S', [GraphQLObjectType('F', ())])))
            ),  # type: ignore
            "    f: _t.List[_t.Optional['S']]",
        ),
        (
            'f',
            GraphQLField(
                type_=GraphQLList(GraphQLNonNull(GraphQLUnionType('S', [GraphQLObjectType('F', ())])))  # type: ignore
            ),
            "    f: _t.Optional[_t.List['S']] = Field(default_factory=list)",
        ),
        (
        ...
        (
            'f',
            GraphQLField(
                type_=GraphQLList(GraphQLList(GraphQLUnionType('S', [GraphQLObjectType('F', ())])))  # type: ignore
            ),
            "    f: _t.Optional[_t.List[_t.Optional[_t.List[_t.Optional['S']]]]] = Field(default_factory=list)",
        ),
    ],
...
@pytest.mark.parametrize(
    'field_name, field, result',
    [
        ('f', GraphQLField(type_=GraphQLInterfaceType('S', {})), "    f: _t.Optional['S'] = Field(default=None)"),
        ('f', GraphQLField(type_=GraphQLNonNull(GraphQLInterfaceType('S', {}))), "    f: 'S'"),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLInterfaceType('S', {}))),
            "    f: _t.Optional[_t.List[_t.Optional['S']]] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLInterfaceType('S', {})))),
            "    f: _t.List[_t.Optional['S']]",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLNonNull(GraphQLInterfaceType('S', {})))),
            "    f: _t.Optional[_t.List['S']] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLNonNull(GraphQLInterfaceType('S', {}))))),
            "    f: _t.List['S']",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLList(GraphQLInterfaceType('S', {})))),
            "    f: _t.Optional[_t.List[_t.Optional[_t.List[_t.Optional['S']]]]] = Field(default_factory=list)",
        ),
    ],
)
...
@pytest.mark.parametrize(
    'field_name, field, result',
    [
        ('f', GraphQLField(type_=GraphQLObjectType('S', {})), "    f: _t.Optional['S'] = Field(default=None)"),
        ('f', GraphQLField(type_=GraphQLNonNull(GraphQLObjectType('S', {}))), "    f: 'S'"),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLObjectType('S', {}))),
            "    f: _t.Optional[_t.List[_t.Optional['S']]] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLObjectType('S', {})))),
            "    f: _t.List[_t.Optional['S']]",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLNonNull(GraphQLObjectType('S', {})))),
            "    f: _t.Optional[_t.List['S']] = Field(default_factory=list)",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLNonNull(GraphQLList(GraphQLNonNull(GraphQLObjectType('S', {}))))),
            "    f: _t.List['S']",
        ),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLList(GraphQLObjectType('S', {})))),
            "    f: _t.Optional[_t.List[_t.Optional[_t.List[_t.Optional['S']]]]] = Field(default_factory=list)",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            'f',
            GraphQLField(type_=GraphQLScalarType('S')),
            "    f: _t.Optional['S'] = Field(default=None, alias='alias_f')",
        ),
        ('f', GraphQLField(type_=GraphQLNonNull(GraphQLScalarType('S'))), "    f: 'S' = Field(..., alias='alias_f')"),
        (
            'f',
            GraphQLField(type_=GraphQLList(GraphQLScalarType('S'))),
